  ...
  return (
    <div style={{ background: 'var(--bg-card)', borderRadius: '16px', border: '1px solid var(--border-subtle)', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '20px 28px' }}>
        {/* Table Header */}
        <div style={{
          display: 'grid', gridTemplateColumns: '100px 1fr 2fr 120px 50px', gap: '12px',
            ...
            return (
              <div key={vlan.id} style={{
                ...
                <input 
                  ...
                  style={{ ...inputStyle, borderColor: isVlanIdInvalid ? 'var(--destructive)' : 'var(--border-subtle)' }} 
                ...
                <input 
                  ...
                  style={{ ...inputStyle, textTransform: 'uppercase', borderColor: isNameInvalid ? 'var(--destructive)' : 'var(--border-subtle)' }} 
